...
class barchart(object):
    ...
    def __init__(self, names1 = None, names2 = None, filename = 'freqs_Fri.csv', labourname = 'E:/PycharmProjects/python-visualising-jeremy/datain/key points.csv'):
        self.names1 = names1
        self.names2 = names2
    ...
    def process(self, grouping = 'No'):
        ...
        if grouping == 'No':
            ...
            ax.set_xticks(ind + width)
            ax.set_xticklabels(np.unique(category), fontsize = 10)
        ...
        # ax.legend((rects1[0], rects2[0]), ( groupname1, groupname2), prop = {'size':10})
